...
### 2 ###
puts journalistes.count { |journalistes| journalistes.match(/\d/)}
puts "-" * 10
...
### 3 ###
puts journalistes.count { |x| x.downcase.match(/aude/)}
puts "-" * 10

### 4 ###
puts journalistes.count { |journalistes| journalistes.match(/^.{1}[A-Z]/)}
puts "-" * 10

### 5 ###
puts journalistes.count { |journalistes| journalistes.match(/[A-Z]/)}
puts "-" * 10

### 6 ###
puts journalistes.join.count("_")
puts "-" * 10
...
### 8 ###
puts journalistes.sort_by { |journalistes| journalistes.length} [0..49]
puts "-" * 10
